...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local5 = lerp(Local3.rgb,MaterialFloat3(0.00000000,0.00000000,1.00000000),0.50000000);
	...
	MaterialFloat Local7 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 1);
	MaterialFloat4 Local8 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,Material_Texture2D_1Sampler,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local9 = MaterialStoreTexSample(Parameters, Local8, 1);
	MaterialFloat Local10 = lerp((0.00000000 - 0.00000000),(0.00000000 + 1.00000000),Local8.g);
	MaterialFloat Local11 = saturate(Local10);
	MaterialFloat3 Local12 = (MaterialFloat3(0.59375799,0.70125997,0.79166698) * ((MaterialFloat3)Local11.r));
	MaterialFloat3 Local13 = lerp(MaterialFloat3(0.59375799,0.70125997,0.79166698),Local12,0.50000000);
	MaterialFloat Local14 = lerp(Local8.g,Local8.b,0.40000001);
	MaterialFloat Local15 = (Local14 * 0.69999999);

	PixelMaterialInputs.EmissiveColor = Local6;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local13;
