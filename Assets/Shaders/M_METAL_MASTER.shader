Shader "Unreal/M_METAL_MASTER"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "Normal_Tex", 2D ) = "white" {}
		Material_Texture2D_1( "Grunge_Tex", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(1.000000,0.876531,0.822917,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[6] = float4(1.000000,0.876531,0.822917,1.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat2 Local7 = (DERIV_BASE_VALUE(Local0) * ((MaterialFloat2)Material.PreshaderBuffer[5].x));
	MaterialFloat Local8 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local7), 1);
	MaterialFloat4 Local9 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,Material_Texture2D_1Sampler,DERIV_BASE_VALUE(Local7),View.MaterialTextureMipBias));
	MaterialFloat Local10 = MaterialStoreTexSample(Parameters, Local9, 1);
	MaterialFloat3 Local11 = lerp(Material.PreshaderBuffer[6].xyz,Material.PreshaderBuffer[5].yzw,Local9.r);
	MaterialFloat Local12 = (Local9.r + Material.PreshaderBuffer[7].x);
	MaterialFloat Local13 = (0.00000000 + Local12);
