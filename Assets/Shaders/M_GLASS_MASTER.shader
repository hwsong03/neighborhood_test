Shader "Unreal/M_GLASS_MASTER"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "T_GLASS_2_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MASK_DIRT_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_GRUNGE_01_BC", 2D ) = "white" {}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat2 Local1 = (DERIV_BASE_VALUE(Local0) * ((MaterialFloat2)4.00000000));
	...
	MaterialFloat3 Local5 = (Local3.rgb * ((MaterialFloat3)0.50000000));
	MaterialFloat3 Local6 = lerp(Local5,MaterialFloat3(0.00000000,0.00000000,1.00000000),0.50000000);
	...
	MaterialFloat3 Local7 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[1].yzw,Material.PreshaderBuffer[1].x);
	MaterialFloat Local8 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 1);
	MaterialFloat4 Local9 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,Material_Texture2D_1Sampler,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local10 = MaterialStoreTexSample(Parameters, Local9, 1);
	MaterialFloat Local11 = lerp((0.00000000 - 0.00000000),(0.00000000 + 1.00000000),Local9.g);
	MaterialFloat Local12 = saturate(Local11);
	MaterialFloat3 Local13 = (MaterialFloat3(0.51003700,0.62660003,0.82291698) * ((MaterialFloat3)Local12.r));
	MaterialFloat Local14 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 0);
	MaterialFloat4 Local15 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,Material_Texture2D_2Sampler,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local16 = MaterialStoreTexSample(Parameters, Local15, 0);
	MaterialFloat3 Local17 = lerp(MaterialFloat3(0.51003700,0.62660003,0.82291698),Local13,Local15.r);
	MaterialFloat Local18 = lerp(Local9.g,Local9.b,0.40000001);
	MaterialFloat Local19 = (Local18 * 0.40000001);

	PixelMaterialInputs.EmissiveColor = Local7;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local17;
	PixelMaterialInputs.Metallic = 0.80000001;
