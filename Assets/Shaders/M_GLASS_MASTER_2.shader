Shader "Unreal/M_GLASS_MASTER_2"
{
	Properties
	{
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local1 = dot(WorldNormalCopy,Parameters.CameraVector);
	MaterialFloat Local2 = max(0.00000000,Local1);
	MaterialFloat Local3 = (1.00000000 - Local2);
	MaterialFloat Local4 = abs(Local3);
	MaterialFloat Local5 = max(Local4,0.00010000);
	MaterialFloat Local6 = PositiveClampedPow(Local5,5.00000000);
	MaterialFloat Local7 = (Local6 * (1.00000000 - 0.04000000));
	MaterialFloat Local8 = (Local7 + 0.04000000);
	MaterialFloat Local9 = lerp(1.00000000,1.51999998,Local8);

	PixelMaterialInputs.EmissiveColor = Local0;
	PixelMaterialInputs.Opacity = 0.40000001;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = MaterialFloat3(0.22916667,0.22916667,0.22916667);
	PixelMaterialInputs.Metallic = 0.00000000;
	PixelMaterialInputs.Specular = 1.00000000;
	PixelMaterialInputs.Roughness = 0.01000000;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = MaterialFloat3(0.00000000,0.00000000,1.00000000);
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = 1.00000000;
	PixelMaterialInputs.Refraction = MaterialFloat3(MaterialFloat2(Local9,0.0f),Material.PreshaderBuffer[2].x);
