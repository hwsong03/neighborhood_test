...
public class ProcessGeneral : MonoBehaviour
{

    // read object
    public GameObject usa_general;
    ...
    void Start()
    {
        ...
        House eachHouse = new House(usa_general.name);

        foreach (Transform child in usa_general.GetComponentInChildren<Transform>())
        {
